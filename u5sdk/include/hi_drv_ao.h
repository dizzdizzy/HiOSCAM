...
/**CNcomment: track映射属性结构体*/
typedef struct hiHI_TRACK_MMAPBUFATTR_S
{
    HI_U8*  pu8UserAddr;     /**<Track Buffer Addr*/ /**<CNcomment:Buffer映射后用户态地址*/
    HI_U32* pu32ReadPtr;     /**<The Pointer of Buffer Read addr */ /**<CNcomment:Buffer读偏移长度指针*/
    HI_U32* pu32WritePtr;    /**<The Pointer of Buffer write addr */ /**<CNcomment:Buffer写偏移长度指针*/
...
typedef struct hiHI_TRACK_MMAPATTR_S
{
    ...
    HI_TRACK_MmapBufAttr_S stMmapBuff;     /**<Buffer Attribute*/ /**<CNcomment:Buffer映射属性*/
} HI_TRACK_MmapAttr_S;
