...
{
    HDMI_DEVICE_ID_E       enHdmiID;
    HDMI_CEC_POWERSTATUS_S enStatus;
}DRV_HDMI_CEC_POWERSTATUS_S;
#if 0
typedef struct 
{
...
enum hiIOCTL_HDMI_E
{
    ...
    IOCTL_HDMI_GET_CECPOWERSTATUS, /* sky(cec) */
    IOCTL_HDMI_SET_CECPOWERSTATUS,
    IOCTL_HDMI_MAX,
};
...
// sky(cec)
#define CMD_HDMI_GET_CECPOWERSTATUS	 _IOWR(HI_ID_HDMI, IOCTL_HDMI_GET_CECPOWERSTATUS,DRV_HDMI_CEC_POWERSTATUS_S)
#define CMD_HDMI_SET_CECPOWERSTATUS  _IOWR(HI_ID_HDMI, IOCTL_HDMI_SET_CECPOWERSTATUS,DRV_HDMI_CEC_POWERSTATUS_S)
