...
/* sky(hdr) */
typedef struct hiDISP_HDRMODE_S
{
    HI_DRV_DISPLAY_E   enDisp;
    HI_U32 enHdrMode;
}DISP_HDRMODE_S;
...
typedef enum hiIOC_DISP_E
{
	...
	IOC_DISP_CURRENT_HDR_MODE, /* sky(hdr) */
    IOC_DISP_SET_BUTT
}IOC_DISP_E;
...
#define CMD_DISP_CURRENT_HDR_MODE    _IOWR(HI_ID_DISP, IOC_DISP_CURRENT_HDR_MODE, DISP_HDRMODE_S) /* sky(hdr) */
#ifdef __cplusplus
#if __cplusplus
}
#endif
