...
// sky(dvbc) for MXL254,MXL214
typedef struct hiDMX_Port_ClockMultiplexed_S
{
    DMX_PORT_MODE_E PortMode;
    HI_U32	PortId;
    HI_BOOL	bMultiplexed;
} DMX_Port_ClockMultiplexed_S;
...
// sky(dvbc) for MXL254,MXL214
#define CMD_DEMUX_PORT_CLOCK_MULTIPLEXED 	_IOWR(HI_ID_DEMUX, 0x1A, DMX_Port_ClockMultiplexed_S)
