...
// sky(cec)
// cec power status
typedef enum hiUNF_CEC_POWERSTATUS_S
{
	HI_UNF_CEC_POWERSTATUS_ON         	= 0x00,
	HI_UNF_CEC_POWERSTATUS_STANDBY   	= 0x01,
	HI_UNF_CEC_POWERSTATUS_STANDBY2ON 	= 0x02,
	HI_UNF_CEC_POWERSTATUS_ON2STANDBY 	= 0x03,
}HI_UNF_CEC_POWERSTATUS_S;
...
// sky(cec)
HI_S32 HI_UNF_HDMI_CEC_SetPowerStatus(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_CEC_POWERSTATUS_S powerStatus);
HI_S32 HI_UNF_HDMI_CEC_GetPowerStatus(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_CEC_POWERSTATUS_S *ppowerStatus);
