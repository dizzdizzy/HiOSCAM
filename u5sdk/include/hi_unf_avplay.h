...
// sky(HFPlayer)
typedef enum hiHFPLAYER_MODE_E
{
	HFMODE_UNDEFINED = 0,
	HFMODE_AC3 		 = 0x1,
	HFMODE_DTS 		 = 0x2,
...
#define	HFPLAYER_ID_AC3		0x666666	/* 6710886 */
#define	HFPLAYER_ID_DTS		0x666667
#define	HFPLAYER_ID_TRUEHD	0x666668	/* 6710888 */
...
// sky()
HI_S32 HI_UNF_AVPLAY_SetAttributes(HI_HANDLE hAvplay, HI_UNF_AVPLAY_ATTR_ID_E enAttrID, HI_VOID *pPara);
...
// sky(HFPlayer)
HI_S32 HI_UNF_AVPLAY_IsDolbyChips(void);
HI_S32 HI_UNF_AVPLAY_SetHfAudioMode(HFPLAYER_MODE_E eHfMode, HI_BOOL support);
HI_S32 HI_UNF_AVPLAY_IsHfAudioAvailable(HFPLAYER_MODE_E eHfMode);
...
//sky(dts)
HI_BOOL HI_UNF_AVPLAY_IsHfdAudio(HI_VOID);
HI_BOOL HI_UNF_AVPLAY_IsHfdApk(HI_VOID);
