...
// sky(btaudio)
typedef struct hiAO_Cast_AnyEnable_Param_S
{
    HI_UNF_SND_E         enSound;
    HI_BOOL              bCastEnable;
} AO_Cast_AnyEnable_Param_S, *AO_Cast_AnyEnable_Param_S_PTR;
...
// sky(btaudio)
#define CMD_AO_CAST_CHKANYENABLE _IOWR  (HI_ID_AO, 0x84, AO_Cast_AnyEnable_Param_S)
