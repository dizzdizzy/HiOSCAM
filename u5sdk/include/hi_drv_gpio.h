...
// sky(5137,changhong)
HI_S32  HI_DRV_GPIO_ChkU5Boards(void);
HI_BOOL HI_DRV_GPIO_IsU5s5137(void);
HI_BOOL HI_DRV_GPIO_IsU5ChCable(void);
HI_BOOL HI_DRV_GPIO_IsU5ChDvbts(void);
HI_BOOL HI_DRV_GPIO_IsU5Delux(void);
HI_S32  HI_DRV_GPIO_WifiForChCable(HI_BOOL poweron);
