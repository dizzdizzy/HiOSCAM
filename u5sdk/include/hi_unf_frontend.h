...
typedef enum hiUNF_QAM_TYPE_E
{
	...
	HI_UNF_MOD_TYPE_QAM_AUTO,		  // sky(atsc)
    ...
    HI_UNF_MOD_TYPE_VSBAUTO,          /**<Enumeration corresponding to (16VSB) mode*/                                                   /**<CNcomment:16VSB对应的枚举值*/
...
typedef enum  hiUNF_TUNER_LOCK_STATUS_E
{
    ...
    HI_UNF_TUNER_SIGNAL_NEVERLOCK, 		   // sky(Add)
    HI_UNF_TUNER_SIGNAL_CHECKER, 		   // sky(Add)
    HI_UNF_TUNER_SIGNAL_BUTT,              /**<Invalid value*/              /**<CNcomment:非法边界值*/
    HI_UNF_TUNER_SIGNAL_DONE = HI_UNF_TUNER_SIGNAL_BUTT,
...
typedef enum    hiUNF_TUNER_DEV_TYPE_E
{
	...
	HI_UNF_TUNER_DEV_TYPE_RS6000,              	/**<RS6000*/                    /**<CNcomment:支持RS6000高频头*/
	HI_UNF_TUNER_DEV_TYPE_DS3000,              	/**<DS3000*/                    /**<CNcomment:支持DS3000高频头*/
    HI_UNF_TUNER_DEV_TYPE_R850,                 /**<R850*/
...
typedef enum    hiUNF_DEMOD_DEV_TYPE_E
{
	...
	HI_UNF_DEMOD_DEV_TYPE_RS6000,            	/**RS6000*/        			/**<CNcomment:支持RS6000*/
	HI_UNF_DEMOD_DEV_TYPE_DS3000,             	/**DS3000*/        			/**<CNcomment:支持DS3000*/
	HI_UNF_DEMOD_DEV_TYPE_LGDT3305,			   	// sky(atsc)
	HI_UNF_DEMOD_DEV_TYPE_LGDT3306,
    HI_UNF_DEMOD_DEV_TYPE_AVL68XX,              /**sky(Avalink 6762)*/
...
typedef enum hiUNF_LNBCTRL_DEV_TYPE_E
{
    ...
    HI_UNF_LNBCTRL_DEV_TYPE_MPS8126,        /**<MPS8126*/                    /**<CNcomment:MPS8126*/
    HI_UNF_LNBCTRL_DEV_TYPE_A8293,			/**<A8293*/                    	 /**<CNcomment:A8293*/
    HI_UNF_LNBCTRL_DEV_TYPE_TPS65233,		/**<TPS65233*/                   /**<CNcomment:TPS65233*/
	HI_UNF_LNBCTRL_DEV_TYPE_STI8035,		/* sky(daqi) */
...
// sky(atsc,futures)
typedef struct  hiUNF_TUNER_ATSC_ATTR_S
{
    HI_UNF_TUNER_TS_FORMAT_E       enTSFormat;      /**<TS format*/                               /**<CNcomment:ts格式*/
    HI_UNF_TUNER_TSCLK_POLAR_E     enTSClkPolar;    /**<TS clock polarization*/                   /**<CNcomment:ts时钟极性*/
    HI_UNF_TUNER_TS_SERIAL_PIN_E   enTSSerialPIN;   /**<TS serial PIN*/                           /**<CNcomment:ts串行数据线*/
} HI_UNF_TUNER_ATSC_ATTR_S;
// sky(isdbt,futures)
typedef struct  hiUNF_TUNER_ISDB_ATTR_S
{
    HI_UNF_TUNER_TS_FORMAT_E       enTSFormat;      /**<TS format*/                               /**<CNcomment:ts格式*/
    HI_UNF_TUNER_TS_SERIAL_PIN_E   enTSSerialPIN;   /**<TS serial PIN*/                           /**<CNcomment:ts串行数据线*/
} HI_UNF_TUNER_ISDBT_ATTR_S;
...
typedef enum hiUNF_TUNER_FE_LNB_BAND_E
{
    ...
    HI_UNF_TUNER_FE_LNB_BAND_DISHPRO,		/* sky(dishpro) */
...
// sky(dvbc)
typedef struct  hiUNF_TUNER_CAB_SIGNALINFO_S
{
    HI_U32                        	u32Freq;                /**<Frequency, in kHz*/         /**<CNcomment:频率，单位：kHz*/
    HI_U32                       	u32SymbolRate;          /**<Band width, in KHz*/        /**<CNcomment:带宽，单位KHz */
    HI_UNF_MODULATION_TYPE_E     	enModType;              /**<Modulation type*/           /**<CNcomment:调制方式*/
} HI_UNF_TUNER_CAB_SIGNALINFO_S;
...
// sky(atsc)
typedef struct  hiUNF_TUNER_ATSC_SIGNALINFO_S
{
    HI_U32                         u32Freq;         /**< Frequency, in kHz */		/**<CNcomment:频?剩???位: kHz */
    HI_UNF_MODULATION_TYPE_E       enModType;       /**< Modulation type */         /**<CNcomment:???品?式 */
} HI_UNF_TUNER_ATSC_SIGNALINFO_S;
...
typedef struct hiUNF_TUNER_SIGNALINFO_S
{
    ...
    union
    {
        ...
        HI_UNF_TUNER_CAB_SIGNALINFO_S 	 stCab;		// sky(dvbc)
        HI_UNF_TUNER_ATSC_SIGNALINFO_S 	 stAtsc;	// sky(atsc)
...
typedef struct  hiUNF_TUNER_CONNECT_PARA_S
{
    ...
    union
    {
        ...
        HI_UNF_ATSC_CONNECT_PARA_S 	stAtsc;	   	//sky(atsc)
    } unConnectPara;
...
HI_S32 HI_UNF_TUNER_SetAtscAttr(HI_U32 u32tunerId , const HI_UNF_TUNER_ATSC_ATTR_S *pstAtscTunerAttr);
HI_S32 HI_UNF_TUNER_SetIsdbAttr(HI_U32 u32tunerId , const HI_UNF_TUNER_ISDBT_ATTR_S *pstIsdbTunerAttr);
...
*/
// sky(dishpro)
HI_S32 HI_UNF_TUNER_SetDishproSwitches(HI_U32 u32TunerId, HI_U32 switches);
...
HI_S32 HI_UNF_TUNER_ProcModuleEnable(HI_U32 u32TunerId, HI_BOOL bEnabled);	 // sky(isdbt)
HI_S32 HI_UNF_TUNER_EnableDisable(HI_U32 u32TunerId, HI_BOOL bEnable);
