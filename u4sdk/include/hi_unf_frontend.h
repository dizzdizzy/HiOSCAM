...
typedef enum    hiUNF_TUNER_DEV_TYPE_E
{
    ...
    HI_UNF_TUNER_DEV_TYPE_MXL683,				// sky(isdb)
...
typedef enum    hiUNF_DEMOD_DEV_TYPE_E
{
    ...
    HI_UNF_DEMOD_DEV_TYPE_MXL683,			   	// sky(isdb)
...
typedef struct hiUNF_TUNER_SIGNALINFO_S
{
    ...
    union
    {
        ...
        HI_UNF_TUNER_ATSC_SIGNALINFO_S 	stCab;		// sky(dvbc)
...
HI_S32 HI_UNF_TUNER_SetIsdbAttr(HI_U32 u32tunerId , const HI_UNF_TUNER_ISDB_ATTR_S *pstIsdbTunerAttr);
