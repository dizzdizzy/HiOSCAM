...
//
// sky(stby.futures)
#define	__STANDBY_CLOCK_AVAILABLE__
#define	__STANDBY_SLEEP_AVAILABLE__
//
//
//
#define	PM_STANDBY_COLD		0
#define	PM_STANDBY_WARM		1
#define	PM_STANDBY_SLEEP	9


HI_S32  HI_UNF_PMOC_Is24HourFormat(void);
HI_S32  HI_UNF_PMOC_ChkStandbyMode(void);
HI_S32  HI_UNF_PMOC_EnterSleepStandby(HI_U32 u32HoldModules);
HI_S32  HI_UNF_PMOC_QuitSleepStandby(HI_VOID);
#if defined(__STANDBY_CLOCK_AVAILABLE__)
HI_S32	HI_UNF_PMOC_ClockInit(void);
HI_S32	HI_UNF_PMOC_ClockDeinit(void);
HI_S32  HI_UNF_PMOC_ClockEnable(void);
HI_S32 	HI_UNF_PMOC_ClockDisable(void);
#endif // defined(__STANDBY_CLOCK_AVAILABLE__)
