...
typedef struct _TUNER_OPS_S
{
	...
	HI_S32  (*tuner_set_atsc_attr)(HI_U32 u32TunerPort, HI_UNF_TUNER_ATSC_ATTR_S *pstTerTunerAttr);
	HI_S32  (*tuner_set_isdb_attr)(HI_U32 u32TunerPort, HI_UNF_TUNER_ISDB_ATTR_S *pstTerTunerAttr);
...
#define TUNER_SETDEMODATTR_CMD _IOWR(HI_TUNER_IOC_MAGIC, 37, TUNER_DATA_S)
...
#define TUNER_TUENR_POWER_SPECTRUM_DATA_CMD _IOWR(HI_TUNER_IOC_MAGIC, 50, TUNER_DATA_S)
// sky(bs)
#define TUNER_BLINDSCAN_STOP_CMD _IOWR(HI_TUNER_IOC_MAGIC, 51, TUNER_DATA_S)
#define TUNER_SET_LNBCONFIG_CMD _IOWR(HI_TUNER_IOC_MAGIC, 52, TUNER_LNBCONFIG_S)
#define TUNER_PROCMONITOR_CMD _IOWR(HI_TUNER_IOC_MAGIC, 53, TUNER_DATA_S) // sky(isdbt)
#define TUNER_SET_DISHPRO_SWITCH_CMD _IOWR(HI_TUNER_IOC_MAGIC, 54, TUNER_DISHPRO_SWITCH_S) // sky(dishpro)
/*
