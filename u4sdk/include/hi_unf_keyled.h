...
// sky(display)
HI_S32 HI_UNF_LED_DisplayCode(HI_U32 u32CodeValue, HI_BOOL lastsave);
HI_S32 HI_UNF_LED_DisplayTexts(const char *str, HI_S32 showtime);
...
// sky(Italy)
HI_S32 HI_UNF_LED_SetStbyPin(HI_BOOL setStby);
HI_S32 HI_UNF_LED_TESTER(HI_U32 u32CodeValue);
